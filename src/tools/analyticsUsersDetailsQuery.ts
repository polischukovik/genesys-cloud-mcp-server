...
import { z } from "zod";
import { usersDetailsQuerySchema } from "./utils/analyticsSchemas.js";
...
const paramsSchema = z.object({
  query: usersDetailsQuerySchema.describe(
    "UserDetailsQuery payload for POST /api/v2/analytics/users/details/query.",
  ),
});
